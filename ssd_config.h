...
#define NAND_4KB_READ_LATENCY_LSB (50000 - 6000) //ns
#define NAND_4KB_READ_LATENCY_MSB (50000 + 6000) //ns
#define NAND_4KB_READ_LATENCY_CSB (0) //not used
#define NAND_READ_LATENCY_LSB (50000 - 6000)
#define NAND_READ_LATENCY_MSB (50000 + 6000)
#define NAND_READ_LATENCY_CSB (0) //not used
#define NAND_PROG_LATENCY (720000 * 1.3)
#define NAND_ERASE_LATENCY (0)
