...
__hash* __hash_init(uint32_t size){
	__hash* res=(__hash*)kzalloc(sizeof(__hash), GFP_KERNEL);
	res->table=(__hash_node*)kzalloc(sizeof(__hash_node)*size*MULTIFACTOR, GFP_KERNEL);
