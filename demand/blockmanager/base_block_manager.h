...
int base_populate_bit (struct blockmanager*, ppa_t ppa);
int base_unpopulate_bit (struct blockmanager*, ppa_t ppa);
int base_erase_bit (struct blockmanager*, ppa_t ppa);
bool base_is_valid_page (struct blockmanager*, ppa_t ppa);
bool base_is_invalid_page (struct blockmanager*, ppa_t ppa);
void base_set_oob(struct blockmanager*, char *data, int len, ppa_t ppa);
char* base_get_oob(struct blockmanager*, ppa_t ppa);
